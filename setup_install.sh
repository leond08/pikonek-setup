...
if is_command apt-get ; then
    ...
    INSTALLER_DEPS=(ipcalc lighttpd python3 sqlite3 dnsmasq python3-pip gawk curl cron wget iptables iptables-persistent iptables-save whiptail git openssl ifupdown ntp)
    # The Web server user,
    LIGHTTPD_USER="www-data"
    # group,
    LIGHTTPD_GROUP="www-data"
